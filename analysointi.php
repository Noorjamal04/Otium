...
<main>
    <div id="text-container">
        ...
        <article class="teksti">
            ...
            Tällä sivulla voit tarkastella omaa terveydentilaasi kaavioiden avulla. HRV, stressi ja vireyskaavio antavat sinulle yhteenvedon aina yhden viikon ajalta.<br>Sivun alareunasta löydät tekemäsi kalenterimerkinnät sekä kyselyt joihin olet vastannut.<br>
            ...
            <br>
            <h2>HRV kaavio</h2>
            <p>Viikon keskiarvosi taulukon tuloksille on: <mark class="blue"><b>71,5.</b></mark> <br> HRV keskiarvosi on hieman koholla, tarkkaile terveydentilaasi ja pyri minimoimaan stressitekijät.</p>
            <div id="chartdiv"></div>
            <br>
            <h2>Vireystaso kaavio</h2>
            <p>Viikon keskiarvosi taulukon tuloksille on: <mark class="blue"><b>3</b></mark><br>Vireystasosi voisi olla hieman parempi. Tarkkaile unen määrää ja laatua, viileässä nukkuminen parantaa unen laatua.</p>
            <div id="chartdiv3"></div>
            <br>
            <h2>Stressi kaavio</h2>
            Viikon keskiarvosi taulukon tuloksille on: <mark class="blue"><b>3,2.</b></mark><br>Stressiarvosi on kohonnut. Pyri tarkkailemaan stressin aiheuttajaa ja minimoi se parhaasi mukaan.<br>
            <br>
...
<div id="text-container2">
    ...
    <article class="teksti">
        ...
        <?php
        //kirjautuneen käyttäjän emaillin kautta
        ...
        // Tulostetaan käyttäjän syötämä tidot kalenteriin currentUseriin kautta.
        ...
        //Kalenteriin merkkintojen tauluko ja niiden päivämäärät
        echo ("<table>
	 	<tr>
      ...
      <th>Päivämäärä</th>
        ...
        //kyselyn merkkintojen tauluko ja niiden päivämäärät
        echo ("<table>
