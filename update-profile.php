...
Päivitä tietosi niistä kentistä joita haluat muokata ja syötä salasanasi varmistuksen vuoksi.
</article>
...
try {
    ...
    //Tiedott päivitetään sql:n
    $sql3 = "UPDATE otium SET email ='$email', pwd ='$pwd', first_name = '$firstName', last_name = '$lastName', gender = '$gender', age = '$age' WHERE id = :id";
